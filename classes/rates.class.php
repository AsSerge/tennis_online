 ...
 * $rate = new Rates($db);
 * 
 * $rate->voteUser() - Добавляет голос пользователя user_id за видеоролик mov_id
 * $rate->voteReferee() - Добавляет голос члена жюри reff_id за видеоролик mov_id
 * 
 * 
 * 
 * 
...
class Rates{
	...
	public $factor_unique		= 2.0; //Множитель для критерия оценки: Уникальность
	public $factor_humor		= 2.0; //Множитель для критерия оценки: Юмор
	public $factor_competition	= 2.0; //Множитель для критерия оценки: Состязательность
	public $factor_hardness		= 2.0; //Множитель для критерия оценки: Сложность
	public $factor_usefulness	= 2.0; //Множитель для критерия оценки: Полезность
